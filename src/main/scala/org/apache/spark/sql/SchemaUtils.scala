...
object SchemaUtils extends Logging {
  ...
  def schemaEvolution(rows: Iterator[InternalRow],
                      sourceSchema: StructType,
                      targetSchema: StructType,
                      defaultValueColumns: Map[String, Column] = Map()): Iterator[InternalRow] = {
    val projection = getSchemaProjection(sourceSchema, targetSchema, defaultValueColumns)
